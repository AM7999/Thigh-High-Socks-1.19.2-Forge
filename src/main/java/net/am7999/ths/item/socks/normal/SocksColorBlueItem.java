...
public abstract class SocksColorBlueItem extends ArmorItem {
    public SocksColorBlueItem(EquipmentSlot slot, Item.Properties properties) {
    ...
    public static class Leggings extends SocksColorBlueItem {
        public Leggings() {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "ths:textures/models/armor/sock_blue_layer_2.png";
        }
    }
}
