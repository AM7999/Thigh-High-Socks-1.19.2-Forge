...
public abstract class SocksColorGreyItem extends ArmorItem {
    public SocksColorGreyItem(EquipmentSlot slot, Item.Properties properties) {
    ...
    public static class Leggings extends SocksColorGreyItem {
        public Leggings() {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "ths:textures/models/armor/sock_grey_layer_2.png";
        }
    }
}
